...
def bno08x_node():
    ...
    bno = BNO08X_I2C(i2c) # BNO080 (0x4b) BNO085 (0x4a)
    ...
    while True:
        ...
        raw_msg.linear_acceleration.x = 0
        raw_msg.linear_acceleration.y = 0
        raw_msg.linear_acceleration.z = 0
...
#         raw_msg.orientation_covariance = [
#             0.01, 0, 0,
#             0, 0.01, 0,
#             0, 0, 0.01
#         ]
